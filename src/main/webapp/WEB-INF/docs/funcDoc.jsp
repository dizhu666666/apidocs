...
<li><a target="mainFrame" href="${pageContext.request.contextPath}/menu/list?type=1&way=2">首页列表</a></li>
<c:forEach items="${pageList }" var="record">
<li><a target="mainFrame" href="${pageContext.request.contextPath}/func/item?id=${record.id}">${record.title }</a></li>
</c:forEach>
</ul>
</li>
</ul>
