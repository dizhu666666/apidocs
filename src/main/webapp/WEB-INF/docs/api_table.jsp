...
<script type="text/javascript" src="${pageContext.request.contextPath}/docs/js/jquery.cookie.js"></script>
<script>
$(function(){
if($("#controller").val()==1){
...
<div class="right-ct">
<form action="${pageContext.request.contextPath}/menu/list?way=1" method="post">
<div class="search-form clearfix">
<ul class="search-ul fl clearfix">
<li><div class="input-prepend">
<span class="add-on" >接口名称</span>
<span><input class="un-input wd3" type="text" placeholder="接口名称" value="${apiName }" name="apiName"/>
</span>
</div></li>
<li><div class="input-prepend">
<span class="add-on" >接口url</span>
<span><input class="un-input wd3" type="text" placeholder="接口url" value="${apiUrl }" onkeydown="change();" name="apiUrl"/>
</span>
</div></li>
...
<a class="btn-group" href="${pageContext.request.contextPath}/api/add" >
...
<a class="btn-group" href="${pageContext.request.contextPath}/api/item?id=${record.id }"><i class="icon icon-pencil"></i>查看</a>
<div name="oprationapi" style="display:none;">
<a class="btn-group" href="${pageContext.request.contextPath}/api/edit?id=${record.id }"><i class="icon icon-pencil"></i>编辑</a>
<a class="btn-group" href="javascript:removeApiItem('${record.id }')"><i class="icon icon-pencil"></i>删除</a>
</div>
</div>
</td>
</tr>
...
function  removeApiItem(id){
	$.ajax({
		   type: "POST",
		   url: "${pageContext.request.contextPath}/api/del",
		   data: {"id":id},
		   dataType:"json",
